...
import com.example.smart.enterpriseplumbing.LoginActivity;
...
public class PinFragment extends CommonBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.product_new_design_layout, container, false);
        ...
        confirm_your_booking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prefs.setStringValueForTag(Constants.FINAL_PRODCUT, final_pro);
                prefs.setStringValueForTag(Constants.FINAL_FINISH, final_finish);
                prefs.setStringValueForTag(Constants.FINAL_FIXTURE, final_fix);
                prefs.setStringValueForTag(Constants.FINAL_BRAND, final_brand);
    ...
    private void setfourthCato(final ArrayList<String> catogory_name_array, final ArrayList<String> catogory_id_array) {
        ...
        try {
            ...
            if (finish1.equals("")) {
                spinner_finish.setSelection(getIndex(spinner_finish, product));
            } else if (!finish1.isEmpty()) {
                spinner_finish.setSelection(getIndex(spinner_finish, finish1));
            }
    ...
    private void setthirdCatogry(final ArrayList<String> catogory_name_array, final ArrayList<String> catogory_id_array) {
        ...
        try {
            ...
            if (product1.equals("")) {
                spinner_fixture.setSelection(getIndex(spinner_Brand, product));
            } else if (!product1.isEmpty()) {
                spinner_fixture.setSelection(getIndex(spinner_Brand, product1));
            }
    ...
    private void setCatogorySpinner(final ArrayList<String> catogory_name_array, final ArrayList<String> catogory_id_array) {
        ...
        try {
            ...
            if (product1.equals("")) {
                ...
                spinner_Location.setSelection(getIndex(spinner_Location, product1));
            }

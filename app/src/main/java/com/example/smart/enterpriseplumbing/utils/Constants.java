...
/**
 * Created by App_DEVELOPER on 6/21/2017.
 */
...
// public static final String HOST_URL = "https://api.pipedrive.com/v1/";
 ...
 // public static final String HOST_URL = "http://ec2-18-217-91-105.us-east-2.compute.amazonaws.com:93/api/order_form/";
  ...
  public static final String HOST_URL = "http://ec2-18-217-91-105.us-east-2.compute.amazonaws.com:93/api/order_form/";
    ...
    //public static final String HOST_URL = "https://api.pipedrive.com/v1";
    public static final String USER_SIGN_URL = "http://site.goigi.technology/kwikshoots/AccountApi/UserRegistration?";
    ...
    //  public static final String GOOGLE_API_KEY = "AIzaSyDXLQMwJLe2r81syZltXY1yf83qMItXKsE";
    public static final String LOG_TAG = "Google Places Autocomplete";
    public static final String GOOGLE_API_KEY = "AIzaSyBRd-TviYzcKTRKFJgqF1mQ5EGRlNNp3g4";

  public static final String PRODUCT_DEATAIL = "orderModelList";

    public static final String USERS_STATUS = "userstatus";
    public static final String GENDER = "gender";
    public static final String LAT = "lat";
    public static final String LON = "lon";
  public static final String NAME = "name";
  public static final String EMAIL ="email" ;
  public static final String ROLE_ID = "roldi";
  public static final String MOBILE_NO = "mobile";
    public static final String ID = "id";
    public static final String USER_NAME_S = "ename";
  public static final String USER_EMAIL_S = "email";
    public static final String DISPACT_ID ="di" ;
    public static final String GATE_CODE = "gat";
  public static final String PLUMBER ="plum";
  ...
  public static final String RESOLUTION = "resol";
  public static final String DIAGONIS = "diagonis";
  public static final String FINISH ="finish" ;
  public static final String FEATURE = "futur";
  public static final String SERVICES_TYPE = "typp";
  public static final String SERVICES_FEE ="fee" ;
  public static final String SER_AMOUNT ="amount" ;
  public static final String PIAB = "paid";
  public static final String DUE = "due";
  public static final String BRAND_TYPE = "brand";
  public static final String ORDER_DATE = "order_date";
  public static final String START_O_DATE = "start_o_date";
  public static final String AUTH = "auth";
  public static final String AUTH_AMOUNT ="auth_amount" ;
  public static final String CHECK ="check" ;
  public static final String COLLECTED = "collected";
  public static final String IN_VOICE = "invoice";
    public static final String POST_ORDER = "Postorder_form/";
    public static final String PRODUCT = "producta";
    public static final String FINAL_BRAND = "finalbrand";
  public static final String FINAL_PRODCUT ="finalprodcut" ;
  public static final String FINAL_FIXTURE = "finalfixture";
  public static final String FINAL_FINISH = "finalfinish";
  public static final String FINAL_DESC ="finaldesc" ;
  public static final String FINAL_DIAGONIS = "finaldiagonis";
  public static final String FINAL_RESOLTI ="finalresolution" ;
  public static final String FINAL_SERVICE = "finalservices";
    public static final String SAVE_EMAIL = "savemail";
  public static final String SAVE_PASSWORD = "savepassword";
  public static final String PREF_NAME = "prefs";
  public static final String KEY_REMEMBER = "remember";
    public static final String SAVE_ID ="ids" ;
  public static final String SAVE_CODE ="code" ;
  public static final String SAVE_FIRST = "savefirst";
  public static final String SAVE_LAST = "savelast";
  public static final String SAVE_ADDRESS = "saveaddres";
  public static final String SAVE_STATE = "savestate";
  public static final String SAVE_CITY = "savecity";
  public static final String SAVE_ZIP = "savezip";

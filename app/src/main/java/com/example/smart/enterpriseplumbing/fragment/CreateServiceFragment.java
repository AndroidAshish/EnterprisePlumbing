...
public class CreateServiceFragment extends CommonBaseFragment {
    ...
    String final_Service,string_service;
    String ser1;
    String ser2;
    String ser3;
    String ser4;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.create_service_layout, container, false);
       ...
       string_service=  prefs.getStringValueForTag(Constants.CREATE_SERVICE_FIRST);


        edit_Ser_First.setText(prefs.getStringValueForTag(Constants.CREATE_SERVICE_F));
        edit_Ser_Second.setText(prefs.getStringValueForTag(Constants.CREATE_SERVICE_S));
        edit_Ser_Third.setText(prefs.getStringValueForTag(Constants.CREATE_SERVICE_T));
        edit_Ser_Fourth.setText(prefs.getStringValueForTag(Constants.CREATE_SERVICE_FO));


        edit_Amount.setText(prefs.getStringValueForTag(Constants.CREATE_AMO_FIRST));
        edit_Amo_First.setText(prefs.getStringValueForTag(Constants.CREATE_AMO_F));
        edit_Amu_Second.setText(prefs.getStringValueForTag(Constants.CREATE_AMO_S));
        edit_Amu_Third.setText(prefs.getStringValueForTag(Constants.CREATE_AMO_T));
        edit_Amu_Fourth.setText(prefs.getStringValueForTag(Constants.CREATE_AMO_FO));
      ...
      /*  String type = prefs.getStringValueForTag(Constants.SERVICES_TYPE);
        ...
        confirm_your_booking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prefs.setStringValueForTag(Constants.CREATE_FINAL_SERVICE, super_Dis);
                prefs.setStringValueForTag(Constants.CREATE_FINAL_AMOUNT, super_amount);
                Toast.makeText(getActivity(), "Data Save", Toast.LENGTH_SHORT).show();


                //this saving fragment state for service fragment
                  prefs.setStringValueForTag(Constants.CREATE_SERVICE_FIRST,final_Service);
                  prefs.setStringValueForTag(Constants.CREATE_SERVICE_F,dis_First);
                  prefs.setStringValueForTag(Constants.CREATE_SERVICE_S,dis_Second);
                  prefs.setStringValueForTag(Constants.CREATE_SERVICE_T,dis_Third);
                  prefs.setStringValueForTag(Constants.CREATE_SERVICE_FO,dis_Fourth);

                  prefs.setStringValueForTag(Constants.CREATE_AMO_FIRST,amount);
                prefs.setStringValueForTag(Constants.CREATE_AMO_F,das_first);
                prefs.setStringValueForTag(Constants.CREATE_AMO_S,das_Second);
                prefs.setStringValueForTag(Constants.CREATE_AMO_T,das_third);
                prefs.setStringValueForTag(Constants.CREATE_AMO_FO,das_fourth);
    ...
    private void setCatogorySpinner(final ArrayList<String> catogory_name_array, final ArrayList<String> catogory_id_array) {
        ...
        try {
            ...
            if (string_service.equals("")) {
                spinner_Location.setSelection(getIndex(spinner_Location, string_service));
            } else if (!string_service.isEmpty()) {
                spinner_Location.setSelection(getIndex(spinner_Location, string_service));
            }
